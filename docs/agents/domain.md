...
**This repo is single-context.** One `CONTEXT.md` and one `docs/adr/` live at the repo root. Neither
file exists yet. `/domain-modeling` creates them when a term or a decision needs a home.
