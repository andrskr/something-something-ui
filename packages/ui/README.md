...
Apps must consume Astryx only through this package, never by importing `@astryxdesign/core` directly.
This keeps the theme, component set, and StyleX bootstrap CSS centralized in one place.
