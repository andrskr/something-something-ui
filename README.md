...
A minimal [Vite+](https://viteplus.dev) monorepo with one TanStack Start application (`apps/web`,
`@acme/web`) and one design-system package (`packages/ui`, `@acme/ui`) that wraps
