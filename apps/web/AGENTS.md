...
One override: import components and CSS through `@acme/ui`, not `@astryxdesign/core` directly — the
SETUP step below doesn't apply here, `packages/ui` already owns that bootstrap.
