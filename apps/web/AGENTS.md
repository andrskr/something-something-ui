...
Generated by `astryx init --features agents` (re-run after an `@astryxdesign/core` bump) — everything
between the markers is regenerated verbatim, don't hand-edit it.
